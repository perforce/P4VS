...
{
    /// <summary>
    /// Summary description for P4DataRetrievalPreferences.
    /// </summary>
    /// 
    [Guid("93F744C8-B872-4541-A650-B57A806F2624")]
    public class P4DataRetrievalPreferences : MsVsShell.DialogPage
    {
        private static Logger logger = LogManager.GetCurrentClassLogger();
        private P4DataRetrievalPreferencesControl page = null;
        ...
        protected override IWin32Window Window
        {
            get
            {
                page = new P4DataRetrievalPreferencesControl();
