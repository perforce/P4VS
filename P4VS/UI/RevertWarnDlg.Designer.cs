namespace Perforce.P4VS
{
	partial class RevertWarnDlg
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RevertWarnDlg));
			...
			this.CancelBtn.YOffset = 1;
			// 
			// ErrorsTB
			// 
			resources.ApplyResources(this.ErrorsTB, "ErrorsTB");
			this.ErrorsTB.CellHeight = 200;
			this.ErrorsTB.CellWidth = 686;
			this.ErrorsTB.Column = 0;
			this.ErrorsTB.ColumnsSpanned = 2;
