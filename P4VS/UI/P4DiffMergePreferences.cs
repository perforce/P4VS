...
{
    /// <summary>
    /// Summary description for P4DiffMergePreferences.
    /// </summary>
    /// 
    [Guid("A8E26F91-810B-42E9-AAD5-C19C88505895")]
    public class P4DiffMergePreferences : MsVsShell.DialogPage
    {
        private static Logger logger = LogManager.GetCurrentClassLogger();
        private P4DiffMergePreferencesControl page = null;
        ...
        protected override IWin32Window Window
        {
            get
            {
                page = new P4DiffMergePreferencesControl();
