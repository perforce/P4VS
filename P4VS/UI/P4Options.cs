...
{
    /// <summary>
    /// Summary description for P4Options.
    /// </summary>
    /// 
    [Guid("F52F4494-CFB2-4114-A621-598B7F3E64E8")]
    public class P4Options : Microsoft.VisualStudio.Shell.DialogPage
    {
        private static Logger logger = LogManager.GetCurrentClassLogger();
        private P4OptionsControl page = null;
        ...
        protected override void OnApply(PageApplyEventArgs e)
        {
            ...
            if (uiShell != null && (uiShell.ShowMessageBox(0, ref clsid,
                                                           messageCaption,
                                                           messageText,
                                                           string.Empty,
                                                           0,
