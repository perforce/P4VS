...
namespace Perforce.P4VS
{
    ...
    /// </summary>
    [Guid("6C391092-50B2-4FB8-8646-299E241B28BA")]
    public class StreamsToolWindow : ToolWindowPane
    {
		private StreamsToolWindowControl control;

		public StreamsToolWindow()
			: base(null)
        {
            // set the window title
			this.Caption = Resources.StreamsToolWindow_Caption;
			...
			this.BitmapIndex = 6;// 0;   // index in the bitmap strip
#endif
            using (DpiAwareness.EnterDpiScope(DpiAwarenessContext.SystemAware))
            {
                control = new StreamsToolWindowControl();
        ...
        /// </summary>
        public void StreamsToolWindowToolbarCommand()
        {
