...
{
    /// <summary>
    /// Summary description for P4LoggingPreferences.
    /// </summary>
    /// 
    [Guid("D58BE6A3-25A1-4443-A24A-EDAA218C0D0E")]
    public class P4LoggingPreferences : MsVsShell.DialogPage
    {
        private static Logger logger = LogManager.GetCurrentClassLogger();
        private P4LoggingPreferencesControl page = null;
        ...
        protected override IWin32Window Window
        {
            get
            {
                page = new P4LoggingPreferencesControl();
