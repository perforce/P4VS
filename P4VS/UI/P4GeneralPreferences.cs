...
{
	/// <summary>
	/// Summary description for P4GeneralPreferences.
	/// </summary>
	/// 
	[Guid("3CEF3284-F677-4915-980D-EA74CC71C762")]
	public class P4GeneralPreferences : MsVsShell.DialogPage
	{
        private static Logger logger = LogManager.GetCurrentClassLogger(); 
        private P4GeneralPreferencesControl page = null;
		...
		protected override IWin32Window Window
		{
			get
			{
				page = new P4GeneralPreferencesControl();
